...
const { getAllCartoon, getRecAll, getCartoon, getRecByGenre, uploadGartoon, getEpCartoon, getAllGenre,searchCartoon, getImageEp, updateCartoon, boughtCartoon, buyCartoon, getBuyCartoon } = require('./Controllers/cartoon');
...
router.get('/mycartoon/bought/:cartoonId/:userId',getBuyCartoon)
